...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const floatingButtonsHTML = `
        <div class="floating-buttons-container">
            <!-- Instagram -->
            <a href="https://www.instagram.com/quincho.elumbral/" 
               target="_blank" 
            ...
            <!-- WhatsApp - Comentado temporalmente hasta que esté habilitado
            <a href="https://wa.me/5492613841247?text=Hola!%20Estoy%20interesado%20en%20reservar%20el%20quincho" 
               target="_blank" 
               rel="noopener noreferrer" 
